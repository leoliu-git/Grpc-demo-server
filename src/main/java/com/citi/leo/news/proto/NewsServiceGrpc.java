...
public final class NewsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.citi.leo.news.proto.NewsProto.NewsRequest,
      com.citi.leo.news.proto.NewsProto.NewsResponse> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "list",
      requestType = com.citi.leo.news.proto.NewsProto.NewsRequest.class,
      responseType = com.citi.leo.news.proto.NewsProto.NewsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.citi.leo.news.proto.NewsProto.NewsRequest,
      com.citi.leo.news.proto.NewsProto.NewsResponse> getListMethod() {
    io.grpc.MethodDescriptor<com.citi.leo.news.proto.NewsProto.NewsRequest, com.citi.leo.news.proto.NewsProto.NewsResponse> getListMethod;
      ...
      synchronized (NewsServiceGrpc.class) {
        if ((getListMethod = NewsServiceGrpc.getListMethod) == null) {
          NewsServiceGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<com.citi.leo.news.proto.NewsProto.NewsRequest, com.citi.leo.news.proto.NewsProto.NewsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "list"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.citi.leo.news.proto.NewsProto.NewsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.citi.leo.news.proto.NewsProto.NewsResponse.getDefaultInstance()))
  ...
  public static abstract class NewsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void list(com.citi.leo.news.proto.NewsProto.NewsRequest request,
        io.grpc.stub.StreamObserver<com.citi.leo.news.proto.NewsProto.NewsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.citi.leo.news.proto.NewsProto.NewsRequest,
                com.citi.leo.news.proto.NewsProto.NewsResponse>(
                  this, METHODID_LIST)))
          .build();
    }
  }
  ...
  public static final class NewsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NewsServiceBlockingStub> {
    ...
    /**
     */
    public com.citi.leo.news.proto.NewsProto.NewsResponse list(com.citi.leo.news.proto.NewsProto.NewsRequest request) {
  ...
  public static final class NewsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NewsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.citi.leo.news.proto.NewsProto.NewsResponse> list(
        com.citi.leo.news.proto.NewsProto.NewsRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((com.citi.leo.news.proto.NewsProto.NewsRequest) request,
              (io.grpc.stub.StreamObserver<com.citi.leo.news.proto.NewsProto.NewsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class NewsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.citi.leo.news.proto.NewsProto.getDescriptor();
    }
